    ...
    getGames: async function (filters = {}) {
        try {
            ...
            if (filters.genreId) {
                ...
                const genreName = genreSelect ?
                    genreSelect.options[genreSelect.selectedIndex]?.textContent : null;

                console.log('Looking for genre name:', genreName);

                games = games.filter(game => {
                    // Match by genre name directly as the API seems to return genre as a string
